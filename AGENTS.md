...
> **Sistemas externos:** 20 repos analisados por evidência em `skills/EXTERNAL_SYSTEMS_INDEX.md` — 9 trading (TA/backtrader/nautilus/freqtrade/ccxt/vectorbt/lumibot/hummingbot/finrl) + 11 agent-infra (memória/harness/coleta/diagramas/red-team/enxame) — todos **advisory-only** (`src/lib/trading/external-systems.ts:1`); copyleft/fair-code/unverified = SPEC-ONLY sem código copiado; execução só em S14 com envelope.
